    ...
    <div>
      ...
      style={{ backgroundImage: "url('/img/chelsea.jpg')" }}>
        ...
        <div className='relative p-5 z-10 font-serif font-bold'>
          <h3 className='text-center text-white text-9xl my-5
          md:text-8xl sm:text-7xl'>404 Not Found</h3>
          <p className='relative text-customSkyblue text-4xl tracking-[0.075rem] my-3
          md:text-3xl md:my-2 sm:text-3xl'>Ooops...!</p>
          <p className='relative text-customSkyblue text-3xl mb-3
          md:text-[25px] sm:text-2xl'>Sorry, the page you are looking for cannot be found.</p>
          <div className='mt-4 text-white text-2xl'>
            <button onClick={handleGoBack} className='w-72 h-12 bg-slate-800 rounded-md mr-7
            md:w-full md:px-4 md:m-0 sm:w-full sm:px-4 sm:m-0 '>&lt; Go Back</button>
            <button onClick={handleTakeHome} className='w-72 h-12 bg-customBlue rounded-md 
