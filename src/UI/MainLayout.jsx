...
export default function MainLayout() {
  ...
  return (
    <section className="relative md:static sm:static">
      <div
        className="w-[calc(100%-200px)] relative flex justify-between items-center h-[75px] left-[200px] px-10 py-0 text-white bg-customBlue border-white border-b text-center
            md:left-0 md:p-0 md:w-full sm:left-0 sm:p-0 sm:w-full sm:h-[160px] sm:flex-col sm:items-center sm:justify-center"
      >
        <div>
          <select
            className="font-sans text-base font-medium text-slate-600 bg-white m-0 rounded-lg border-b border-slate-400 py-2 pr-6 pl-2 focus:outline-none disabled:opacity-50 md:ml-2"
            name="Season"
            defaultValue={order}
            onChange={(e) => {
