export default function Header() {
  return (
    <header
      className="header bg-radial-eclipse-bottom flex flex-col h-screen w-[200px] justify-between items-center fixed top-0 left-0 font-serif text-customSkyblue font-normal
    ...
    >
      ...
      />
      <h1
        className="leading-normal text-2xl px-2.5 pl-5 mb-36
