...
import { getPlayerAppearances, getPlayerTouches, getPlayerFouls} from '../../Database/playerStats'
    ...
    return (
        <section className='flex flex-wrap sm:flex-col'>
                ...
                [playerAppearances, playerTouches, playerFouls].map((content, index)=>{
                    ...
                    return (
                    <div key={index} className='flex-1 flex-wrap shadow-[10px_10px_142px_0_rgba(101,149,239,0.75)] backdrop-blur-2xl rounded-2xl ml-2 my-2'>
                    ...
                    <div className='flex flex-wrap justify-center items-center gap-x-10 p-3 mb-3'>
                        ...
                        content.map((stat)=>{
                            ...
                            <div key={stat.label} className='font-serif mb-5'>
                                ...
                                <div className='flex items-center justify-center border border-blue-300 rounded-md w-40 h-10 p-2 mt-1 font-bold text-white'>{stat.value}</div>
                            </div>
                            )
                        })
                        }
